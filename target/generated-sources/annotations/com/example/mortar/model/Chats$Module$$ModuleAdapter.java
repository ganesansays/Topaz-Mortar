 ...
 */
public final class Chats$Module$$ModuleAdapter extends ModuleAdapter<com.example.mortar.model.Chats.Module> {
  private static final String[] INJECTS = { "members/com.example.mortar.model.Chats", };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { };

  public Chats$Module$$ModuleAdapter() {
    super(INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, false /*complete*/, true /*library*/);
  }

  @Override
  public com.example.mortar.model.Chats.Module newModule() {
    return new com.example.mortar.model.Chats.Module();
  }
  ...
  public static final class ProvideMessagePollThreadProvidesAdapter extends Binding<java.util.concurrent.Executor>
    ...
    private final com.example.mortar.model.Chats.Module module;

    public ProvideMessagePollThreadProvidesAdapter(com.example.mortar.model.Chats.Module module) {
      super("java.util.concurrent.Executor", null, IS_SINGLETON, "com.example.mortar.model.Chats.Module.provideMessagePollThread()");
      this.module = module;
      setLibrary(true);
    }
