 ...
 */
public final class Login$Module$$ModuleAdapter extends ModuleAdapter<com.example.mortar.model.Login.Module> {
  private static final String[] INJECTS = { "members/com.example.mortar.model.Login", };
  private static final Class<?>[] STATIC_INJECTIONS = { };
  private static final Class<?>[] INCLUDES = { };

  public Login$Module$$ModuleAdapter() {
    super(INJECTS, STATIC_INJECTIONS, false /*overrides*/, INCLUDES, false /*complete*/, true /*library*/);
  }

  @Override
  public com.example.mortar.model.Login.Module newModule() {
    return new com.example.mortar.model.Login.Module();
  }
  ...
  public static final class ProvideMessagePollThreadProvidesAdapter extends Binding<java.util.concurrent.Executor>
    ...
    private final com.example.mortar.model.Login.Module module;

    public ProvideMessagePollThreadProvidesAdapter(com.example.mortar.model.Login.Module module) {
      super("java.util.concurrent.Executor", null, IS_SINGLETON, "com.example.mortar.model.Login.Module.provideMessagePollThread()");
      this.module = module;
      setLibrary(true);
    }
